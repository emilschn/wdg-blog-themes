					...
					<div id="post-<?php the_ID(); ?>" <?php post_class('g post'); ?>>
						<div class="single_post">
							...
							<header>
								...
								<span class="theauthor single-postmeta"><?php _e('Posted in ','mythemeshop'); the_category(', '); ?><?php _e(' By ','mythemeshop'); the_author_posts_link(); ?><?php _e(' On ','mythemeshop'); the_time('j F Y'); ?></span>
